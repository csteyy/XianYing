...
import { ChevronLeft, Download, Share2, Trash2, Search, X, FileText, SlidersHorizontal, Users, Check, Eye, Calendar, Clock, ChevronDown, ChevronRight } from 'lucide-react';
...
const initialGalleryItems: GalleryItem[] = [
  ...
  },
  {
    ...
    date: '2025-10-17',
    duration: '32:15',
    participantNames: ['Alice', 'Bob', 'Frank', 'Grace'],
    sourceRecordName: '小组讨论',
  },
  {
    id: 3,
    title: '午餐交流分析',
    date: '2025-10-16',
    duration: '28:45',
    participantNames: ['Bob', 'Charlie', 'Heidi'],
    sourceRecordName: '午餐交流',
  },
  {
    id: 4,
    title: '头脑风暴可视化',
    date: '2025-10-15',
    duration: '52:10',
    participantNames: ['Alice', 'Charlie', 'Diana', 'Eve', 'Frank', 'Grace'],
    sourceRecordName: '项目评审会',
  },
  {
    id: 5,
    title: '周例会回顾',
  ...
  },
  {
    ...
    date: '2025-08-10',
    duration: '01:30:45',
    participantNames: ['Diana', 'Eve', 'Frank', 'Grace', 'Heidi', 'Alice', 'Bob', 'Charlie'],
    sourceRecordName: '产品评审',
  },
];
...
export function GalleryPage({ onNavigate }: GalleryPageProps) {
  ...
  const handleDelete = (e: React.MouseEvent, item: GalleryItem) => {
    ...
    toast.success('作品已删除', { description: `${item.title} 已从作品库移除` });
  };
                    ...
                    >
                      <div className="px-6 space-y-4" style={{ paddingBottom: 28 }}>
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            onNavigate('data-analysis', { readOnly: true, from: 'gallery' });
                          }}
                          className="flex items-center gap-2 text-sm active:opacity-70 transition-opacity"
                          style={{ color: '#3b82f6' }}
                        >
                          <FileText className="w-4 h-4" />
                          <span>来源记录：{item.sourceRecordName}</span>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Button size="icon" variant="ghost" className="h-10 w-10 rounded-xl text-destructive shrink-0" onClick={(e) => handleDelete(e, item)}>
