...
import { isFileASRAvailable } from '../services/volcengine/config';
...
export function PostRecordingEditPage({
  ...
  mode = 'manual',
  sceneName: initialSceneName = 'AI生成场景名称',
  recordingTime = 0,
  wavBuffer,
  streamingText,
  ...
  const handleComplete = async () => {
    if (!isGSheetsAvailable() || transcriptItems.length === 0) {
      ...
      onNavigate('data-analysis', {
        ...
        from: 'home', sceneName, mode, recordingTime,
      });
      return;
    }
